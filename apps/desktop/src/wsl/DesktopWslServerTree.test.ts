...
// The service only distinguishes archive roots by the .asar suffix and reads
// them through the (asar-aware, in Electron) fs — so a plain directory named
// server.asar exercises the full extraction path under plain Node.
