    ...
    Effect.gen(function* () {
      ...
      yield* fs.writeFileString(
        ...
        [
          ...
          '    rate_limits: { five_hour: { utilization: 25, resets_at: "2027-01-15T08:00:00.000Z" }, seven_day: { utilization: 60, resets_at: "2027-01-18T08:00:00.000Z" } },',
          "    behaviors: null,",
          "  } : undefined;",
          "  if (!response) return;",
