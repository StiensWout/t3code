...
/**
 * Visits use server-backed timestamps so local clock skew cannot clear unread
 * state. A completed snooze wake is also server-backed and may be newer than
 * the thread projection's updatedAt.
 */
